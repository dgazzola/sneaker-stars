...
class Seeder {
  static async seed() {
    ...
    const nike2 = await Shoe.query().insert({name: "Nike SB Dunk Low Bummy", category: "casual" , color: "COCONUT MILK/SEAFOAM-YELLOW STRIKE" , url: "https://images.stockx.com/360/Nike-Dunk-SB-Low-Mummy/Images/Nike-Dunk-SB-Low-Mummy/Lv2/img17.jpg?fm=avif&auto=compress&w=326&dpr=2&updated_at=1635746790&h=217.33333333333334&q=75", description: "The Nike SB Dunk Low Mummy draws inspiration from the Ancient Egyptian mummification process."  })
    const nike3 = await Shoe.query().insert({name: "Nike SB Dunk Low Dummy", category: "casual" , color: "COCONUT MILK/SEAFOAM-YELLOW STRIKE" , url: "https://images.stockx.com/360/Nike-Dunk-SB-Low-Mummy/Images/Nike-Dunk-SB-Low-Mummy/Lv2/img17.jpg?fm=avif&auto=compress&w=326&dpr=2&updated_at=1635746790&h=217.33333333333334&q=75", description: "The Nike SB Dunk Low Mummy draws inspiration from the Ancient Egyptian mummification process."  })
    ...
    const user1 = await User.query().insert({username: "Ronald Regan", email: "ronalddaman@manlymail.net", password: "1234"})
    const user2 = await User.query().insert({username: "john doe", email: "ronalddaman@me.net", password: "1234"})
    const user3 = await User.query().insert({username: "lincolccmaksnra", email: "rdaman@manlymail.net", password: "1234"})
